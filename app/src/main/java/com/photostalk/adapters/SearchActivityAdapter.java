...
public class SearchActivityAdapter extends RefreshAdapter {
    ...
    public SearchActivityAdapter(SearchActivity searchActivity, OnActionListener onActionListener) {
    ...
    public int getItemViewType(int position) {
        return mSearchActivity.getType();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (mSearchActivity.getType() == HomeActivity.USER)
    ...
    public UserModel getUser(int position) {
        ...
        switch (mSearchActivity.getType()) {
    ...
    public Story getStory(int position) {
        if (position >= mItems.size()) return null;
        if (mSearchActivity.getType() == HomeActivity.TRENDING) {
    ...
    private void bindUser(ViewHolderUser vh, int position) {
        ...
        if (User.getInstance().getId().equals(user.getId()))
            ...
            vh.mFollowButton.setText(user.isFollowingUser() ? R.string.following : (user.isFollowRequestSent()) ? R.string.requested : R.string.follow);
